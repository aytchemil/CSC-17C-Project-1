...
// Expanded ASCII backgrounds for each level
const string LEVEL_BACKGROUNDS[MAX_LEVELS] = {
    "Level 1: Simple Grid\n-------------------\n|                 |\n|      2x2        |\n|                 |\n-------------------\n",
    "Level 2: Forest\n   /\\      /\\      /\\\n  /  \\    /  \\    /  \\\n /    \\  /    \\  /    \\\n/      \\/      \\/      \\\n---------------------\n",
    "Level 3: Ocean\n ~~~~~~~~~~~  ~~~~~\n ~      ~    ~    ~\n ~~~~~~~     ~~~~~~\n ~    ~     ~     ~\n ~      ~   ~~~~~~~ \n-------------------\n",
    "Level 4: Mountain\n      /\\      \n     /  \\     \n    /    \\    \n   /      \\   \n  /________\\  \n---------------\n",
...
{
    cout << LEVEL_BACKGROUNDS[level - 1];
}
...
void displayBoard()
{
    displayBackground(currentBoardSize / 2);
...
int main()
{
    ...
    while (true)
    {
        ...
        else
        {
            ...
            // Display the empty board after selecting a level
            displayBoard();
